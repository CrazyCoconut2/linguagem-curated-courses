...
2. **Save** it under `databases/{language-code}/your-database-name.linguagem`.
   - `{language-code}` is the target language (`es`, `pt`, `fr`, …).
...
| `targetLanguage` | ISO-style language code used by Linguagem |
